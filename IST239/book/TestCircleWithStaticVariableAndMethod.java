public class TestCircleWithStaticVariableAndMethod {
  ...
  public static void main(String[] args) {
    // Create circle1
    CircleWithStaticVariableAndMethod circle1 =
      new CircleWithStaticVariableAndMethod();
    ...
    // Create circle2
    CircleWithStaticVariableAndMethod circle2 =
      new CircleWithStaticVariableAndMethod(5);
  ...
  public static void printCircle(
    CircleWithStaticVariableAndMethod c) {
